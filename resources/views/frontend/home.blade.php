...
<div class="container">
            <div class="row g-0 bs__innovations">
                ...
                <div class="col-lg-5">
                    <div class="innovation__contant">
                        ...
                        <a href="work" class="btn view__btn f16 font__semibold ">View our works<img src="{{ asset('frontend/images/cross-arrow.svg') }}"
            ...
            <div class="row g-0">
                <div class="wdp__scroll__arrow">
                    <a href="home#scrollToExplore">
                        <img src="{{ asset('frontend/images/Scroll-explore.svg') }}" alt="">
                        <span class="description">Scroll to explore</span>
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="wdp__digital__list">
                    <div class="digital__box">
                        ...
                        <div class="digital__content">
                            <h5>Startup</h5>
                            <p class="f16 font__semibold">We work with you from scratch, build your products and help
                                you grow.</p>
                        </div>
                    </div>
                    <div class="digital__box">
                        ...
                        <div class="digital__content">
                            <h5>Enterprise</h5>
                            <p class="f16 font__semibold">We can help with software development with faster and improved
                                business out growth.</p>
                        </div>
                    </div>
                    <div class="digital__box">
                        <div class="digital__picture">
                        ...
                        <div class="digital__content">
                            <h5>Agency</h5>
                            <p class="f16 font__semibold">We provide the resources to accomplish work with heavy
                                workloads</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row g-0 service__header">
            <div class="col-lg-12">
                <div class="services">
                    <h2>Our Services</h2>
                    <p>We play to our strengths: Ideating, creating and shipping<br /> wonderful things on the internet.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row g-0  process__view d-md-block d-none">
            <div class="col-md-12">
                <ul class="steps__services nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="process__list" role="presentation">
                        <p class="title1">02</p>
                        <a class="" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button"
                    ...
                    <li class="process__list" role="presentation">
                        <p class="title1">03</p>
                        <a class="" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button"
                    ...
                    <li class="process__list" role="presentation">
                        <p class="title1">04</p>
                        <a class="" id="tab4-tab" data-bs-toggle="tab" data-bs-target="#tab-4" type="button" role="tab"
                    ...
                    <li class="process__list" role="presentation">
                        <p class="title1">05</p>
                        <a class="" id="tab5-tab" data-bs-toggle="tab" data-bs-target="#tab-5" type="button" role="tab"
                ...
                <div class="row g-lg-0 exp__ofproduct">
                    <div class="col-lg-5 offset-g-1 col-md-6">
                        <div class="wdp__ser__slid">
                            ...
                            <p class="f16">Design that makes most of your business needs. Users are tickled pink of
                                everything we produce. We're proud of our design, it is our ace.
                            </p>
                            <p class="f16">
        ...
        <div class="row g-0 process__view d-md-none d-block">
            <div class="col-md-12">
                <ul class="steps__services nav nav-tabs" id="myTab" role="tablist">
                    <li class="process__list" role="presentation">
                        <a class="active" id="home-tab1" data-bs-toggle="tab" data-bs-target="#home1" type="button"
                            role="tab" aria-controls="home" aria-selected="true">
                            <p class="title1">Design</p>
                        </a>
                    </li>
                    <li class="process__list" role="presentation">
                        <a class="" id="profile-tab2" data-bs-toggle="tab" data-bs-target="#profile2" type="button"
                            role="tab" aria-controls="profile" aria-selected="false">
                            <p class="title1">Front-end</p>
                        </a>
                    </li>
                    <li class="process__list" role="presentation">
                        <a class="" id="contact-tab3" data-bs-toggle="tab" data-bs-target="#contact3" type="button"
                            role="tab" aria-controls="contact" aria-selected="false">
                            <p class="title1">Back-end</p>
                        </a>
                    </li>
                    <li class="process__list" role="presentation">
                        <a class="" id="tab4-tab4" data-bs-toggle="tab" data-bs-target="#tab-44" type="button"
                            role="tab" aria-controls="tab-4" aria-selected="false">
                            <p class="title1">Mobile app</p>
                        </a>
                    </li>
                    <li class="process__list" role="presentation">
                        <a class="" id="tab5-tab5" data-bs-toggle="tab" data-bs-target="#tab-55" type="button"
                ...
                <div class="good__staff">
                    <a class="wdp__staff" href="#">
                        <p class="title1">More Good Stuff
                            <svg class="arrow__45d" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" width="16px" height="16px"
                                viewBox="0 0 14 14" version="1.1">
            ...
            <div class="col-lg-11">
                <div class="sl__zing">
                    <div class="customer__say first__customer">
                        ...
                        <p>“Aliqua id fugiat nostrud irure ex duis ea quis id quis ad et. Sunt qui esse pariatur duis
